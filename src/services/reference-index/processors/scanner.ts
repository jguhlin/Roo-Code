		...
		while (attempts < MAX_BATCH_RETRIES && !success) {
			...
			try {
				...
				const points = batchBlocks.map((block, index) => {
					const normalizedAbsolutePath = generateNormalizedAbsolutePath(block.file_path, directory)
					...
					return {
						...
						payload: {
							filePath: generateRelativeFilePath(normalizedAbsolutePath, directory),
